...
def get_ffme_returns():
    ...
    """
    me_m = pd.read_csv("/content/Portfolio/Portfolios_Formed_on_ME_monthly_EW.csv",
...
def get_hfi_returns():
    ...
    """
    hfi = pd.read_csv("/content/Portfolio/hedgefundindices.csv",
...
def get_ind_file(filetype):
    ...
    ind = pd.read_csv(f"/content/Portfolio/ind30_m_{name}.csv", header=0, index_col=0)/divisor
